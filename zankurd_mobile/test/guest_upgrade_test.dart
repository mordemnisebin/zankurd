...
void main() {
  ...
  group('GuestUpgrade — upgradeGuestAccount metodu', () {
    test('AuthProvider.test() üzerinde upgradeGuestAccount çağrılabilir', () async {
  ...
  group('GuestUpgrade — profil ekranı CTA görünürlüğü', () {
    testWidgets(
      'misafir kullanıcıya "Hesabını Kaydet" CTA gösterilir',
      (tester) async {
    ...
    testWidgets(
      'kalıcı kullanıcıda "Hesabını Kaydet" CTA gösterilmez',
      (tester) async {
  ...
  group('GuestUpgrade — dialog akışı', () {
    testWidgets(
      'CTA tıklanınca e-posta/şifre dialog açılır',
      (tester) async {
        final guestAuth = _GuestAuthProvider();
        await tester.pumpWidget(
          _wrapWithProviders(
    ...
    testWidgets(
      'boş form gönderilemez — doğrulama hataları gösterilir',
      (tester) async {
        final guestAuth = _GuestAuthProvider();
        await tester.pumpWidget(
          _wrapWithProviders(
    ...
    testWidgets(
      'geçerli form gönderilince upgradeGuestAccount çağrılır',
      (tester) async {
        final guestAuth = _GuestAuthProvider();
        await tester.pumpWidget(
          _wrapWithProviders(
