...
|---|---|---:|---:|---:|---:|---:|---:|
| `active_import_ready` | `quarantine` | `csv` | 10000 | 10000 | false | false | 0 |
...
| `live_kurmanci_export` | `historical_snapshot` | `csv` | 377 | 377 | false | false | 0 |
| `offline_runtime_bank` | `runtime_primary` | `dart_quiz_question` | 2347 | 2347 | true | true | 0 |
...
| `translated_batches` | `candidate_pool` | `csv` | 24 | 24 | false | false | 0 |
| `translated_batches` | `candidate_pool` | `csv` | 12 | 12 | false | false | 0 |
| `wave2_publish_candidates` | `quarantine` | `csv` | 49 | 49 | false | false | 0 |
