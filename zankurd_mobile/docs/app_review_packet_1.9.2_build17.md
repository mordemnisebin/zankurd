# ZanKurd iOS 1.9.2 (17) — App Review Packet

Bu paket, mevcut kaynak koddan üretilen 1.9.2 (17) release adayı içindir.
...
- **Sekme içeriği durum çubuğunun altına giriyordu**; güvenli alan eklendi.
...
- Candidate build: 1.9.2 (17). App Store Connect upload and Binary State are
...
the app and declares no location collection. Before uploading build 17, the
...
- Enter the current owner phone number and the confirmed support email in App
  ...
  in source control.
- Upload the exact build 17 and reconcile App Privacy answers before sending
  it to review.
